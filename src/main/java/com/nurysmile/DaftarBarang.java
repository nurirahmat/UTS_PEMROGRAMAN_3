...
public class DaftarBarang extends javax.swing.JFrame {
    ...
    private List<Barang> listOfBarang = ObservableCollections.observableList(new ArrayList<Barang>());
    /**
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${listOfBarang}");
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, eLProperty, jTable1);
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${barangRusak}"));
        columnBinding.setColumnName("Barang Rusak");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String sContent = JsonProcessors.fetchJsonURL("http://nurismile.com/getDataJson.php?API=brg123");
        barangList = new Gson().fromJson(sContent,BarangList.class);
        
        List<Barang> brgList = new ArrayList<Barang>();
        for(Barang st: barangList.getBarangList()){
            brgList.add(st);
        }
       
        setListOfBarang(brgList);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarSuplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public BarangList getBarangList() {
        return barangList;
    }

    public void setBarangList(BarangList barangList) {
        this.barangList = barangList;
    }

    public List<Barang> getListOfBarang() {
        return listOfBarang;
    }

    public void setListOfBarang(List<Barang> listOfBarang) {
        List<Barang> old = this.listOfBarang;
        this.listOfBarang = listOfBarang;
        firePropertyChange("listOfBarang", old, listOfBarang);
    }
}
